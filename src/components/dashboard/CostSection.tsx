...
export function CostSection({ month, totalIncome, totalVar, totalFixed, totalSalaries, initialExtra, varByClient, varByMember, salariesByOwner }: Props) {
  // Extra náklady zahrnují i platy majitelů (ExtraTable je sčítá dohromady)
  const [extraTotal, setExtraTotal] = useState(initialExtra + totalSalaries)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div className="grid grid-cols-4 divide-x divide-gray-200">
          ...
          <div className="px-6 py-5">
            ...
            <div className="text-xs text-gray-400 mt-1">var + extra (vč. platů) + fixní</div>
          </div>
          <div className="px-6 py-5">
      ...
      {/* Extra náklady (editovatelné) + platy majitelů */}
      <ExtraTable month={month} salaries={salariesByOwner} onTotalsChange={setExtraTotal} />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 px-5 py-4">
          <div className="text-xs font-medium text-gray-500 mb-1">Extra (vč. platů)</div>
